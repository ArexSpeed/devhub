...
import { AngularIcon, CPlusIcon, CSharpcon, CssIcon, DrupalIcon, HtmlIcon, JavaIcon, JavaScriptIcon, MongoIcon, NetIcon, NextIcon, NodeIcon, PhpIcon, PostgresIcon, PythonIcon, ReactIcon, SassIcon, TailwindIcon, TypeScriptIcon, WordpressIcon } from "components/Icons/SkillsIcons";

const SkillsIconSwitcher = ({ name, className }) => {
  switch (name) {
    case 'html':
